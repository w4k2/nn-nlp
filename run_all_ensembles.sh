...
python test_ensemble.py --dataset_name=esp_fake --attribute=text --mode=9M
python test_ensemble.py --dataset_name=esp_fake --attribute=title --mode=9M
python test_ensemble.py --dataset_name=bs_detector --attribute=text --mode=9M
python test_ensemble.py --dataset_name=bs_detector --attribute=title --mode=9M
python test_ensemble.py --dataset_name=mixed --attribute=text --mode=9M
python test_ensemble.py --dataset_name=mixed --attribute=title --mode=9M